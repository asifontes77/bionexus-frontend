...
const configuration = { activateTitle: "Activar tipo de pago", deactivateTitle: "Desactivar tipo de pago", activateMessage: "El tipo de pago volverá a estar disponible.", deactivateMessage: "La forma de pago permanecerá en el catálogo, pero no estará disponible para nuevas operaciones.", label: record => record?.description || "Registro seleccionado" };
