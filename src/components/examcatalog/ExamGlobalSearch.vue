<template>
  <section class="exam-global-search" @keydown.esc="closeResults">
    <BioNexusFormField class="exam-global-search-field" label="Buscar en todo el catalogo" field-id="exam-global-search"><div class="exam-global-search-control">
...
/* BIO NEXUS GLOBAL SEARCH OVERLAY FIX END */</style>
