    ...
    <section class="worksheet-content">
        <section v-show="tab === 'editor'" class="worksheet-editor-panel">
          <div class="worksheet-toolbar" role="toolbar" aria-label="Formato de texto">
            <select class="worksheet-toolbar-select" title="Tipo de parrafo" aria-label="Tipo de parrafo" @change="setBlockType"><option value="p">Parrafo</option><option value="h3">Titulo</option><option value="h4">Subtitulo</option></select>
            <select class="worksheet-toolbar-select" title="Interlineado" aria-label="Interlineado" @change="setLineHeight"><option value="1">Compacto</option><option value="1.2">Normal</option><option value="1.5">1.5 lineas</option><option value="2">Doble</option></select>
