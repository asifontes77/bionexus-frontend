...
const configuration = { activateTitle: "Activar germen", deactivateTitle: "Desactivar germen", activateMessage: "El germen volverá a estar disponible en antibiogramas.", deactivateMessage: "El registro permanecerá visible, pero no estará disponible en nuevos antibiogramas.", label: record => record?.germen || "Registro seleccionado" };
