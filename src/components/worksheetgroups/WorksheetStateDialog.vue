...
const configuration = { activateTitle: "Activar grupo de hoja de trabajo", deactivateTitle: "Desactivar grupo de hoja de trabajo", activateMessage: "El grupo de hoja de trabajo volverá a estar disponible para nuevas asignaciones.", deactivateMessage: "El grupo de hoja de trabajo permanecerá visible, pero no admitirá nuevas asignaciones.", label: record => record?.description || "Grupo de hoja de trabajo" };
