...
.exam-order-list li.keyboard-selected{position:relative;z-index:2;scroll-margin-block:24px;cursor:ns-resize;border:2px solid var(--bio-nexus-color-primary);background:var(--bio-nexus-color-info-soft);box-shadow:0 0 0 3px rgba(20,105,170,.16),inset 5px 0 0 var(--bio-nexus-color-accent)}.exam-order-list li.keyboard-selected .select-row>span:not(.drag-icon):not(.order-number){padding-right:215px}.exam-order-list li.keyboard-selected::after{content:"SELECCIONADO · ↑ ↓ · ENTER · ESC";position:absolute;right:92px;top:5px;color:var(--bio-nexus-color-primary);font-size:8px;font-weight:800;letter-spacing:.035em;line-height:1;white-space:nowrap;pointer-events:none}.exam-order-list li.keyboard-selected .order-number{border:2px solid var(--bio-nexus-color-primary);background:var(--bio-nexus-color-primary);color:#fff;transform:scale(1.08)}.exam-order-list li.dragging{opacity:.72;transform:scale(.995);border-color:var(--bio-nexus-color-accent);box-shadow:inset 3px 0 0 var(--bio-nexus-color-accent)}
