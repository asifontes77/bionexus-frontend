const FIELDS = Object.freeze([
  ...
  'currency_symbol_position', 'monetary_decimals', 'first_day_of_week', 'decimal_separator',
...
const REGIONAL_OPTIONS = Object.freeze({ locale: ['es-VE'], time_zone: ['America/Caracas'], date_format: ['dd/MM/yyyy', 'dd-MM-yyyy', 'yyyy-MM-dd'], hour_cycle: ['h12', 'h23'], currency_code: ['VES'], currency_symbol_position: ['before', 'after'], first_day_of_week: ['monday', 'sunday'], decimal_separator: [',', '.'] })
...
export function validateApplicationSettings(value) {
  ...
  if(String(value?.currency_symbol||'').trim()===''||String(value?.currency_symbol||'').length>12)errors.push('El símbolo monetario debe contener entre 1 y 12 caracteres.')
