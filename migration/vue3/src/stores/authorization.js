...
export const useAuthorizationStore = defineStore(
  'authorization',
  {
    ...
    getters: {
      ...
      deniedPermissions: (state) =>
        state.context?.deniedPermissions ?? [],
    ...
    actions: {
      ...
      hasRole(roleCode) {
        ...
        return this.context.roles.includes(
          normalizedCode
        )
      },
      ...
      hasPermission(permissionCode) {
        ...
        if (
          this.context.deniedPermissions.includes(
            normalizedCode
          )
        ) {
          return false
        ...
        return this.context.permissions.includes(
          normalizedCode
        )
      },
